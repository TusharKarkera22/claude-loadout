...
Confirm what is being added before writing files. Refuse to import items of type `hook` unless the user has set `install.allowHookImport: true` in `claude-profiles.config.json`.
